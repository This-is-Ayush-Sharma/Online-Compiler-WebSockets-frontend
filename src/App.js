...
const socket = io.connect("https://onlinecompilerwebsockets1.onrender.com");
    ...
    <div className="App">
      <div className='code'>
        ...
        <div className='codeArea'>
          <textarea placeholder='please write your code here' style={{ fontSize: FontSize }} onChange={(e) => setCode(e.target.value)} value={Code} />
        </div>
      </div>
